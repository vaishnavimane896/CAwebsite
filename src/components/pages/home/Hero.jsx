    ...
    <section className="bg-background relative overflow-hidden border-b border-border">
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-12 py-20 md:py-28 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="pt-2 flex flex-wrap gap-3.5">
            <Link to="/consaltation">
              <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-white font-semibold rounded-xl px-6 py-6 text-sm shadow-md shadow-secondary/10 transition-all cursor-pointer">
                Book Consultation
              </Button>
            </Link>
            <Link to="/services">
              <Button size="lg" variant="outline" className="border-slate-200 text-slate-800 font-semibold rounded-xl px-6 py-6 text-sm bg-white hover:bg-slate-50 transition-all cursor-pointer">
                Explore Services
              </Button>
            </Link>
          </div>
          ...
          <div className="pt-8 border-t border-slate-100">
            <p className="text-[10px] font-extrabold text-slate-400 tracking-wider uppercase mb-4">
              Trusted Across Industrial Verticals
            </p>
            <div className="flex flex-wrap gap-8 text-slate-400/80">
        ...
        <motion.div
          ...
          className="lg:col-span-5 bg-white rounded-2xl border border-border shadow-md shadow-slate-100/60 p-6 flex flex-col justify-between h-[340px]"
        >
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <h3 className="text-sm font-bold text-slate-900">Q3 Enterprise Metrics</h3>
            </div>
          ...
          <div className="flex items-end gap-3.5 h-48 pt-4 border-b border-slate-100">
            {bars.map((h, i) => (
              <div key={i} className="flex-1 flex flex-col items-center h-full justify-end group">
                ...
                >
                  ...
                  <div className="opacity-0 group-hover:opacity-100 absolute -top-8 left-1/2 -translate-x-1/2 bg-slate-900 text-white text-[10px] font-bold px-1.5 py-0.5 rounded transition-opacity pointer-events-none shadow-sm z-20">
                    {h}%
                  </div>
                </motion.div>
              </div>
